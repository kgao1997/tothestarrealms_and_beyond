...
p1 = Player(authority = 50, deck = [scout, scout, scout, scout], in_play = [barter_world], hand = [], combat = 0, trade = 0, discard = [scout, scout, scout, scout, viper, viper], num_to_discard = 0)
